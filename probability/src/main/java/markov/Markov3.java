...
public final class Markov3 implements JMC {
    ...
    private static final int BOTTOM_PITCH_BOUND = 50;
    private static final int TOP_PITCH_BOUND = 100;
    private static final int PITCH_INTERVAL = TOP_PITCH_BOUND - BOTTOM_PITCH_BOUND;

    private static final String FOLDER = "originals\\";
    private static final String NAME = "brahms_hungarian_dance"; // Replace with your midi file
